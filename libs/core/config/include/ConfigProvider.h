...
public:
  ...
  static zenith::Result<ConfigProvider, std::string>
  create(std::unique_ptr<IConfigSource> source, std::unique_ptr<IConfigParser> parser,
  ...
  ConfigProvider(std::unique_ptr<IConfigSource> source, std::unique_ptr<IConfigParser> parser,
